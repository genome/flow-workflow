...
class WorkflowHistorianUpdateAction(BasicActionBase):
    ...
    def execute(self, net, color_descriptor, active_tokens, service_interfaces):
        ...
        token = net.token(head(active_tokens))
        fields = self._get_runtime_fields(token, net)
